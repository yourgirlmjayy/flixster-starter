...
const App = () => {
  ...
  const getMovies = async () => {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0Y2NkNWViYjMzNzBlYjc4MzQxNWViZTYxMjFhOGYxNyIsInN1YiI6IjY2Njc4NTU3M2RlNTFiZmE0YzFjMmU2ZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.NBzva_Lu1kD0S-TVYFRe2TpeBbFuJnblRAPNLZUbbfE",
      },
    };
  ...
  useEffect(
    ...
    [
      page,
      searchInput,
    ] /* fetches data  immediately because useEffect has page and search text deendency */
  );
  ...
  return (
    <div className="App">
      <div className="movieInfo">
        {/* display name of app*/}
        <b><h1 className="app-name">🎬 Flixter</h1></b>
      ...
      <footer className="App-footer">
        <p>© 2024 Flixter, All Rights Reserved<br/>Instagram: @flixter</p>
      </footer>
    </div>
  );
};
